...
select a.PRSCRBR_ID, b.sex, b.PrimarySpecialty, b.MedTrainFlag, b.MedSchoolYOG, b.USTrained, b.YOB, b.FIPSCounty
...
proc sql;
create table DCH070SL.Merged_all_TX as
select a.*, b.*
...
data DCH070SL.Merged_all_TX ;
    set DCH070SL.Merged_all_TX ;
    phy_exp = Year - MedSchool_YOG;
    phy_age = Year - YOB;
run;

proc export data = DCH070SL.Merged_all_TX
outfile = '/sas/vrdc/users/dch070/files/_uploads/Merged_all_TX.csv'
dbms = csv
replace;
run;